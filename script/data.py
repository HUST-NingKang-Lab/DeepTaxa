...
parser.add_argument('-p', '--path', default='./mmseqs_result', type=str, help='indicate the absolute/relative directory path of mmseqs result, default is \'./mmseqs_result\'')
...
#set arguement
mmseqs_result = args.path
files_fn = args.file
data_fn = args.output

#loading metadata
metafile = './config/bac120_taxonomy_r214.tsv'

#generating the genome dictionary 
genomefile,genomelist = 'config/rep-genome-genus1083.lst',[]
...
markerfile,markerlst = 'config/marker_gene.list',[]
