...
parser.add_argument('-m', '--model', default='./data/model.sav', type=str, help='indicate the model file, default is \'./data/model.sav\'')
...
model = pt.load(model_fn, map_location=device)
model.eval()
